...
new Vue({
	...
	data: {
		title: 		"Creamos marketing digital, diseño y servicios de desarrollo que son simples."
...
new Vue({
	...
	data: {
		title: "Lunes a viernes 8 am-5pm (PST)"
	}
});
...
new Vue({
	...
	data: {
		title: 'Servicios para aplicaciones móviles',
		url: 'https://pynely.com/es/services/development/mobile-app.html'
	}
});
...
new Vue({
	...
	data: {
		title: 'Desarrollo de WordPress',
		url: 'https://pynely.com/es/services/development/wordpress.html'
	}
});
...
new Vue({
	...
	data: {
		title: 'Aplicación móvil UX / UI',
		url: 'https://pynely.com/es/services/design/mobile-app-ux-ui.html'
	}
});
...
new Vue({
	...
	data: {
		title: 'Sitio web UX / UI',
		url: 'https://pynely.com/es/services/design/website-ux-ui.html'
	}
});
...
new Vue({
	...
	data: {
		...
		url: 'https://pynely.com/es/services/marketing/social-media-marketing.html'
	}
});
...
new Vue({
	...
	data: {
		title: 'Anuncios de pago por clic',
		url: 'https://pynely.com/es/services/marketing/pay-per-click-ads.html'
	}
});
...
new Vue({
	...
	data: {
		...
		url: "https://pynely.com/es/policies/terms.html"
	}
});
...
new Vue({
	...
	data: {
		title: 'Intimidad',
		url: "https://pynely.com/es/policies/privacy.html"
	}
});
...
new Vue({
	...
	data: {
		url: 'https://pynely.com/es/about.html',
