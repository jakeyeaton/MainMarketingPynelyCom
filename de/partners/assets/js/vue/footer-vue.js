/*
Business Info Label - Label
*/
//Business Info Label - Location Label
new Vue({
	el: '#footer-location-label',
	data: {
		title: 'Hergestellt in:'
	}
});
//Business Info Label - Location City
new Vue({
	el: '#footer-location-city',
	data: {
		title: 'Seattle, Wa'
	}
});
//Business Info Label - Short Discription
new Vue({
	el: "#footer-short-description",
	data: {
		title: 		"Wir schaffen digitale Marketing-, Design- und Entwicklungsdienstleistungen, die einfach sind."
...
new Vue({
	el: "#footer-email-label",
	data: {
		title: "Email:"
	}
});
//Business Info Label - Email Address
new Vue({
	el: "#footer-email-address",
	data: {
		title: "hello@pynely.com"
		}
});
//Business Info Label - Chat Label
new Vue({
	el: "#footer-chat-label",
	data: {
		title: "Chatte mit uns:"
	}
});
//Business Info Label - Chat Trigger
new Vue({
	el: "#footer-chat-trigger",
	data: {
		title: "Live-Chat"
	}
});
...
new Vue({
	...
	data: {
		title: 'Mobile App Dienstleistungen',
		url: 'https://pynely.com/de/services/development/mobile-app.html'
	}
});
...
new Vue({
	...
	data: {
		...
		url: 'https://pynely.com/de/services/development/wordpress.html'
	}
});
...
new Vue({
	...
	data: {
		...
		url: 'https://pynely.com/de/services/design/mobile-app-ux-ui.html'
	}
});
...
new Vue({
	...
	data: {
		title: 'Website UX / UI',
		url: 'https://pynely.com/de/services/design/website-ux-ui.html'
	}
});
...
new Vue({
	...
	data: {
		title: "Marketingdienstleistungen"
	}
});
...
new Vue({
	...
	data: {
		...
		url: 'https://pynely.com/de/services/marketing/social-media-marketing.html'
	}
});
...
new Vue({
	...
	data: {
		title: 'Pay-Per-Click-Anzeigen',
		url: 'https://pynely.com/de/services/marketing/pay-per-click-ads.html'
	}
});
...
//Terms of Service - Bottom Footer
new Vue({
	el: '#footer-bottom-terms',
	data: {
		title: 'Nutzungsbedingungen',
		url: "https://pynely.com/en/policies/terms.html"
	}
});

//Privacy Policy - Bottom Footer
new Vue({
	el: '#footer-bottom-privacy',
	data: {
		title: 'Privatsphäre',
		url: "https://pynely.com/de/policies/privacy.html"
	}
});
...
new Vue({
	...
	data: {
		title: 'Arbeitsplätze',
		url: "https://pynely.com/en/jobs/main.html"
	}
});
//Blog - Bottom Footer
new Vue({
...
//Company News - Bottom Footer
new Vue({
	el: '#footer-bottom-companyNews',
	data: {
		title: 'Unternehmens Nachrichten',
...
new Vue({
	...
	data: {
		title: 'Partners',
		url: 'https://www.pynely.com/de/partners/home.html'
	}
});
...
new Vue({
	...
	data: {
		url: 'https://pynely.com/de/about.html',
		title: 'Über uns'
	}
});
...
new Vue({
	...
	data: {
		title: "Geben Sie uns ein folgen"
	}
})
