...
new Vue({
	...
	data: {
		title: 		"Nous créons des services de marketing numérique, de conception et de développement qui sont simples."
...
new Vue({
	...
	data: {
		title: "Lun-Ven. 8h-17h (heure du Pacifique)"
	}
});
...
new Vue({
	...
	data: {
		title: 'Services pour applications mobiles',
		url: 'https://pynely.com/fr/services/development/mobile-app.html'
	}
});
...
new Vue({
	...
	data: {
		...
		url: 'https://pynely.com/fr/services/development/wordpress.html'
	}
});
...
new Vue({
	...
	data: {
		...
		url: 'https://pynely.com/fr/services/design/mobile-app-ux-ui.html'
	}
});
...
new Vue({
	...
	data: {
		title: 'Site UX / UI',
		url: 'https://pynely.com/fr/services/design/website-ux-ui.html'
	}
});
...
new Vue({
	...
	data: {
		...
		url: 'https://pynely.com/fr/services/marketing/social-media-marketing.html'
	}
});
...
new Vue({
	...
	data: {
		title: 'Annonces Pay-Per-Click',
		url: 'https://pynely.com/fr/services/marketing/pay-per-click-ads.html'
	}
});
...
new Vue({
	...
	data: {
		...
		url: "https://pynely.com/fr/policies/terms.html"
	}
});
...
new Vue({
	...
	data: {
		title: 'Intimité',
		url: "https://pynely.com/fr/policies/privacy.html"
	}
});
...
new Vue({
	...
	data: {
		url: 'https://pynely.com/fr/about.html',
