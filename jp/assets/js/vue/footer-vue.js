...
new Vue({
	...
	data: {
		title:
		"シンプルなデジタルマーケティング、設計、開発サービスを作成しています。"
	}
});
...
new Vue({
	...
	data: {
		title: 'モバイルアプリケーションサービス',
		url: 'https://pynely.com/jp/services/development/mobile-app.html'
	}
});
...
new Vue({
	...
	data: {
		title: 'ワードプレス開発',
		url: 'https://pynely.com/jp/services/development/wordpress.html'
	}
});
...
new Vue({
	...
	data: {
		title: 'モバイルApp UX / UI',
		url: 'https://pynely.com/jp/services/design/mobile-app-ux-ui.html'
	}
});
...
new Vue({
	...
	data: {
		title: 'ウェブサイトUX / UI',
		url: 'https://pynely.com/jp/services/design/website-ux-ui.html'
	}
});
...
new Vue({
	...
	data: {
		...
		url: 'https://pynely.com/jp/services/marketing/social-media-marketing.html'
	}
});
...
new Vue({
	...
	data: {
		title: 'ペイパークリック広告',
		url: 'https://pynely.com/jp/services/marketing/pay-per-click-ads.html'
	}
});
...
new Vue({
	...
	data: {
		title: '利用規約',
		url: "https://pynely.com/jp/policies/terms.html"
	}
});
...
new Vue({
	...
	data: {
		title: 'プライバシー',
		url: "https://pynely.com/jp/policies/privacy.html"
	}
});
...
new Vue({
	...
	data: {
		url: 'https://pynely.com/jp/about.html',
		title: '私たちに関しては'
	}
});
